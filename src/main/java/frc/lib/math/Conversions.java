...
public class Conversions {
    ...
    // * @return Meters
    // */
    // public static double falconToMeters(double positionCounts, double
    // circumference, double gearRatio){
    ...
    // * @return Falcon Position Counts
    // */
    // public static double MetersToFalcon(double meters, double circumference,
    // double gearRatio){
    ...
    public static double MPSToNEO(double velocity, double circumference, double gearRatio) {
        ...
        double encCount = motorRPM * (42.0 / 600);
        return encCount;
    }

    public static double NEOToMPS(double enc, double circumference, double gearRatio) {
        double motorRPM = enc * (600.0 / 42.0);
        double mechRPM = motorRPM / gearRatio;
        return mechRPM;
    }
    ...
    public static double NEOToDegrees(double enc, double gearRatio) {
        return enc * (360.0 / (gearRatio * 42.0));
    }

    public static double NEOToMeters(double enc, double circumference, double gearRatio){
        return enc * (circumference / (gearRatio * 42.0));
    }
}